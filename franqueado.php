							...
							<div class="col">
								<div class="header_top_content d-flex flex-row align-items-center justify-content-start">
									<div class="logo" style="width:20%">
										<img  width="55%" src="images/logo.png"><img>
									</div>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Torne-se Um de Nossos Franqueados</div>
							<div class="home_text">Tornou-se referência na cidade de Marabá por trabalhar com venda de produtos de 0 a 16 anos</div>
							<div class="button home_button"><a href="#"><span>Contato</span><span>Contato</span></a></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row icon_boxes_row">
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							...
							<div class="icon_box_title">1</div>
						</div>
				...
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="images/icon_1.svg" alt=""></div>
							<div class="icon_box_title">4</div>
						</div>
						<div class="icon_box_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lorem maximus malesuada lorem maximus mauris.</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="images/icon_1.svg" alt=""></div>
							<div class="icon_box_title">5</div>
						</div>
						<div class="icon_box_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lorem maximus malesuada lorem maximus mauris.</div>
					</div>
				</div>
				<div class="col-xl-4 col-lg-6">
					<div class="icon_box">
						<div class="icon_box_title_container d-flex flex-row align-items-center justify-content-start">
							<div class="icon_box_icon"><img src="images/icon_1.svg" alt=""></div>
							<div class="icon_box_title">6</div>
						</div>
						<div class="icon_box_text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec lorem maximus malesuada lorem maximus mauris.</div>
					</div>
				</div>
				...
				<div class="col-Aprincipal milestone_col">
					<div class="milestone d-flex flex-row align-items-center justify-content-start">
						...
						<div class="milestone_content">
							...
							<div class="milestone_text">Anos no Mercado</div>
						</div>
					</div>
				</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						...
						<div class="footer_contact">
							...
							<div class="footer_contact_form_container">
								<form action="#" class="footer_contact_form" id="footer_contact_form">
									...
									<textarea class="footer_contact_input footer_contact_textarea" placeholder="Messagem" required="required"></textarea>
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_hours">
							<div class="footer_hours_title">Horario de Funcionamento</div>
							<ul class="hours_list">
