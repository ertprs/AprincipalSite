                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./View/excluir_colaborador.php">Excluir</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./View/cadastrar_colaborador.php">Clima Organizacional</a></li>
                            <li><a href="./chart-morris.html">Avaliação de Desempenho</a></li>
                            <li><a href="./chart-chartjs.html">Outros</a></li>
                            <li><a href="./chart-chartist.html">Criar Formulario</a></li>
                            <li><a href="./chart-peity.html">Departamentos</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">EAD</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-user menu-icon"></i> <span class="nav-text">Setores</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./View/cadastrar_colaborador.php">Financeiro</a></li>
                            <li><a href="./View/editar_colaborador.php">Vendas</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./View/cadastrar_colaborador.php">Geral</a></li>
                            <li><a href="./chart-morris.html">Setor</a></li>
                        </ul>
                    </li>
                    <li class="nav-label">Processo Seletivo</li>
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-user menu-icon"></i> <span class="nav-text">Gerir Vagas</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./View/cadastrar_colaborador.php">Criar Vaga</a></li>
                            <li><a href="./View/editar_colaborador.php">Ver Candidaturas</a></li>
                        </ul>
                    </li>
