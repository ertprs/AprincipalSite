/**
 * Variáveis que guardarão os códigos base64 das imagens selecionadas que serão enviadas ao servidor
 */
...
/**
 * Função que pega uma imagem, verifica o seu tamanho e a exibe ao lado do
 * input file
 */
...
if (defineImagem === "fotoPrincipalY") {
      ...
      document.getElementById("cardAp").style.backgroundImage = data;
