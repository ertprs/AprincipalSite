...
<input id="dashboard" type="hidden" value="<?php echo $dashboard?>"></input>
            ...
            <ul class="metismenu" id="menu">
              ...
              <li  id="asite" style="display:none">
                  ...
                  <ul aria-expanded="false">
                    <li id="asite1"  style="display:none"><a href="blog.php">Blog</a></li>
                    <li id="asite2"  style="display:none"><a href="produtos.php">Produtos</a></li>
                ...
                <li  id="adesign" style="display:none">
                  ...
                  <ul aria-expanded="false">
                      <li id="adesign1"    style="display:none"><a href="baby+.php">baby +</a></li>
                      <li id="adesign2"    style="display:none"><a href="cartao_vendedores.php">Vendedores</a></li>
                      <li id="adesign3"    style="display:none"><a href="cartao_vendedores.php">Certificado</a></li>
                  </ul>
              </li>
              ...
              <li id="acolaborador"  style="display:none">
                    ...
                    <ul aria-expanded="false">
                        <li  id="acolaborador1"   style="display:none"><a href="cadastrar_colaborador.php">Cadastrar</a></li>
                        <li  id="acolaborador2"   style="display:none"><a href="editar_colaborador.php">Editar</a></li>
                    </ul>
                </li>
                    ...
                    <ul aria-expanded="false">
                        <li id="aforms1"   style="display:none"><a href="climaOrganizacional.php">Clima Organizacional</a></li>
                        <li id="aforms2"   style="display:none"><a href="AvaliacaoDesempenho.php">Avaliação de Desempenho</a></li>
                        <li id="aforms3"   style="display:none"><a href="chart-chartjs.html">Outros</a></li>
                        <li   style="display:none"><a href="chart-chartist.html">Novo Formulario</a></li>
                        <li id="aforms4"   style="display:none"><a href="departamentos.php">Departamentos</a></li>
                    </ul>
                </li>
                <li id="avagas"  style="display:none">
                    ...
                    <ul aria-expanded="false">
                        <li id="avagas1"   style="display:none"><a href="gerir_vagas.php">Criar Vaga</a></li>
                ...
                <li id="amaterial"  style="display:none">
                    ...
                    <ul aria-expanded="false">
                        <li id="amaterial1"    style="display:none"><a href="laborador.php">Criar Curso</a></li>
                        <li id="amaterial2"   style="display:none" ><a href="ecodor.php">Gerir Curso</a></li>
                    </ul>
                </li>
                <li id="aresultados"  style="display:none">
                    ...
                    <ul aria-expanded="false">
                        <li  id="aresultados1"   style="display:none"><a href="aborador.php">Geral</a></li>
                        <li  id="aresultados2"   style="display:none"><a href="chart-morris.html">Setor</a></li>
                    </ul>
                </li>
                <li id="acurso"  style="display:none">
                    ...
                    <ul aria-expanded="false">
                        <li id="acurso1"   style="display:none"><a href="cadastrolaborador.php">Geral</a></li>
                        <li id="acurso2"   style="display:none"><a href="chart-morris.html">Setor</a></li>
                    </ul>
                </li>
                <li id="cabecalho_configuracao" class="nav-label"  style="display:none">Configurações</li>
                <li id="aconfig"  style="display:none">
                    <a class="has-arrow"  href="acesso.php" aria-expanded="false">
