                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                                    <form>
                                        ...
                                        <button type="button" onclick="SalvaDepartamento()" class="btn btn-dark">Cadastrar Departamento</button>
                                    </form>
                                </div>
                            </div>
                        </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer d-flex justify-content-center">
            <button class="btn btn-dark" style="width:10rem" onclick="EditaDEP()">Editar</button>
          </div>'
        </div>
      </div>
    </div>
